package net.al0046.labrelarver.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        dropSelf(ModBlocks.LABRE_LARVER_BLOCK.get());
        // dropSelf(ModBlocks.MAGIC_BLOCK.get());

        this.add(ModBlocks.LABRE_LARVER_ORE.get(),
                block -> createOreDrop(ModBlocks.LABRE_LARVER_ORE.get(), ModItems.RAW_LABRE_LARVER.get()));
        this.add(ModBlocks.AZURITE_DEEPSLATE_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.AZURITE_DEEPSLATE_ORE.get(), ModItems.RAW_LABRE_LARVER.get(), 2, 5));
        this.add(ModBlocks.AZURITE_END_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.AZURITE_END_ORE.get(), ModItems.RAW_LABRE_LARVER.get(), 4, 8));
        this.add(ModBlocks.AZURITE_NETHER_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.AZURITE_NETHER_ORE.get(), ModItems.RAW_LABRE_LARVER.get(), 1, 6));
