package net.al0046.labrelarver.entity.client;
    ...
    private static final Map<CapybaraVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CapybaraVariant.class), map -> {
                map.put(CapybaraVariant.BROWN,
                        ResourceLocation.fromNamespaceAndPath(LabreLarverMod.MOD_ID, "textures/entity/capybara/capybara_brown.png"));
                map.put(CapybaraVariant.SNOW,
                        ResourceLocation.fromNamespaceAndPath(LabreLarverMod.MOD_ID, "textures/entity/capybara/capybara_snow.png"));
            });
