package net.al0046.labrelarver.block;

import net.al0046.labrelarver.LabreLarverMod;
import net.al0046.labrelarver.block.custom.MagicBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, LabreLarverMod.MOD_ID);

    public static final RegistryObject<Block> LABRE_LARVER_BLOCK = registerBlock("labre_larver_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));


    public static final RegistryObject<Block> LABRE_LARVER_ORE = registerBlock("labre_larver_ore",
    ...
    public static final RegistryObject<Block> AZURITE_STAIRS = registerBlock("azurite_stairs",
            () -> new StairBlock(ModBlocks.LABRE_LARVER_BLOCK.get().defaultBlockState(),
